...
namespace ML
{
    ...
    {
        /// <summary>
        /// model input class for WorkLogsModelDuration.
        /// </summary>
        ...
        /// <summary>
        /// model output class for WorkLogsModelDuration.
        /// </summary>
        ...
        private static string MLNetModelPath = Path.GetFullPath("WorkLogsModelDuration.mlnet");
        ...
        private static IEnumerable<string> GetLabels(ModelOutput result)
        {
            ...
            var labelColumn = schema.GetColumnOrNull("Quantity");
            if (labelColumn == null)
            {
                throw new Exception("Quantity column not found. Make sure the name searched for matches the name in the schema.");
            }
