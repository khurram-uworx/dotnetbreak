...
namespace ML
{
    ...
    {
        /// <summary>
        /// model input class for WorkLogsModelTicket.
        /// </summary>
        ...
        /// <summary>
        /// model output class for WorkLogsModelTicket.
        /// </summary>
        ...
        private static string MLNetModelPath = Path.GetFullPath("WorkLogsModelTicket.mlnet");
        ...
        private static IEnumerable<string> GetLabels(ModelOutput result)
        {
            ...
            var labelColumn = schema.GetColumnOrNull("Ticket");
            if (labelColumn == null)
            {
                throw new Exception("Ticket column not found. Make sure the name searched for matches the name in the schema.");
            }
